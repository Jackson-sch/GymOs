                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className="text-xs uppercase font-bold text-primary tracking-widest">
                          {plan.durationDays >= 360 ? "Anual" : plan.durationDays >= 90 ? "Trimestral" : "Mensual"}
                        </span>
                    ...
                    <Button
                      ...
                      className={`w-full h-11 rounded-xl font-bold text-xs uppercase tracking-wider ${
                        isSelected ? "bg-primary text-primary-foreground" : "bg-white/10 text-foreground hover:bg-white/20"
                      }`}
                    >
                      Inscribirme Ahora
                    </Button>

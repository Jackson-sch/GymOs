      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <CardContent className="p-6 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-[9px] bg-emerald-500/10 text-emerald-400 border-emerald-500/30 uppercase font-bold">
                {financialMetrics.todayCount} Cobros Hoy
              </Badge>
            </div>
            <div>
              <p className="text-3xl font-serif font-bold text-foreground">
                {formatCurrency(financialMetrics.todayTotal)}
              </p>
        ...
        <Card className="glass-card border-white/5 overflow-hidden relative group">
          <CardContent className="p-6 space-y-2">
            ...
            <div>
              <p className="text-3xl font-serif font-bold text-foreground">
                {formatCurrency(financialMetrics.monthTotal)}
              </p>
              <p className="text-[9px] uppercase font-bold tracking-[0.2em] text-muted-foreground mt-1">
                Ingresos este Mes
              </p>
        ...
        <Card className="glass-card border-white/5 overflow-hidden relative group">
          <CardContent className="p-6 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-[9px] bg-white/5 border-white/10 text-muted-foreground uppercase font-bold">
                Promedio / Socio
              </Badge>
            </div>
            <div>

      ...
      <div className="grid grid-cols-1 gap-6">
        {automations.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="p-6 rounded-3xl bg-white/5 border border-white/10 space-y-4 flex flex-col sm:flex-row sm:items-center justify-between gap-6 hover:border-primary/30 transition-colors shadow-xl"
            >
